...
function Card({image}) {
  ...
  return (
    <div className= {`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] overflow-hidden bg-[#020220] border-2 border-[#0000ff66] rounded-2xl hover:shadow-2xl hover:shadow-blue-950 hover:border-4 hover:border-white cursor-pointer
